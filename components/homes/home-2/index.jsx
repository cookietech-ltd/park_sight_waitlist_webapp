            ...
            <div className="col-md-7 col-lg-6 offset-lg-1 d-flex align-items-center mb-sm-80">
              <div className="wow fadeInUp">
                ...
                <p className="section-text mb-60 mb-md-40 mb-sm-30">
                  <span className="section-title-inline">Who?</span> I’m Akash Shahriar, a software engineer
  specializing in Android and full-stack mobile development with over 5 years of experience. 
  I build robust, scalable, and secure cross-platform applications using Kotlin, Flutter, 
  Jetpack Compose, and modern backend technologies. I’m passionate about performance, clean architecture, and delivering intuitive user experiences across mobile and web platforms.
                </p>
